...
| true_latent_ode_v2_seed42 | bwhhfekh | 2026-06-28 | scripts/true_latent_ode_v2.py | RMSE 86.1 μm / CI-cov 0.768 / KL 0.500 nats (best ckpt ep10) | #23 #24 | GPU (Colab T4); 778 augmented sequences (77 eyes, start-point subseq); best ckpt epoch 10/200 — same pattern as v1: KL peaked at ep10 then collapsed to ~0.03–0.13 post-warmup; RMSE drifted 88–91 μm after ep10; RMSE FAILS bar, CI FAILS bar; partial collapse pattern persists despite 10x more sequences; root cause: beta annealing to 1.0 overwhelms reconstruction on small data |
| true_latent_ode_v3_seed42 | rpe2r55y | 2026-06-28 | scripts/true_latent_ode_v3.py | IN PROGRESS | #23 #25 | GPU (Colab T4); 6,752 variable-window sequences (77 eyes, all start+end combos, min_len=3); fixed beta=0.1 (beta-VAE, no warmup); 300 epochs |
